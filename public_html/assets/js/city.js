...
var CVS = document.getElementById("floating_city");
...
STR_OPT = [50,2]; // 0 = Buildings, 1 = CityPartsDivisions
...
for (var i = 0; i < STR_OPT[0] ; i++) { // goes by the num buildings
  ...
  wmv = eww/50; wmh = ewh/50;
  ww = eww-wmv*2; wh = ewh-wmh*2;
  twin = mw*mh;

  onw = makeWindows(mw,mh,2);
  DecProp = makeDecors(rpos,h,rwid,rheg);
